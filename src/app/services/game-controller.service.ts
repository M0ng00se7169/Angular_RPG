...
import { Chapter, SuccessOptions } from '../models/chapters';
        ...
        switch(character.class) {
            case ClassOptions.warrior:
                this.mainCharacter = new Warrior(character.name, character.gender, character.race, 1, 10,
                    {attack: 0, sneak: 0, persuade: 0, intelligence: 0}, new Weapon("Knife", 1, 3), new Armor("Clothes", 0));
                break;
                ...
                case SuccessOptions.rewardEquipment:
                    ...
                    this.currentChapter.rewards.equipment.forEach(equipment => {
                        if (equipment instanceof Armor) {
                            messages.push(`${equipment.name} -- Attack Barier Bonus: ${equipment.attackBarierBonus}`);
                        } else {
