...
export class Armor {
    name: string;
    attackBarierBonus: number;

    constructor(name: string, attackBarierBonus: number) {
        this.name = name;
        this.attackBarierBonus = attackBarierBonus;
    }
}
...
export class Hero extends BaseCharacter {
    ...
    equipNewArmor(armor: Armor): void {
        if(this.equippedArmor) {
            this.barriers.attack -= this.equippedArmor.attackBarierBonus;
        }

        this.equippedArmor = armor;
        this.barriers.attack += armor.attackBarierBonus;
    }
...
export class Warrior extends Hero {
    constructor(name, gender, race, level, health, skills, weapon, armor) {
        ...
        this.spriteUrl = this.gender === GenderOptions.male ? "./assets/warrior_male.png" : "./assets/warrior_male.png" ;
    }
